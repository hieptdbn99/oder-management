@extends('layout.master');
 ...
 .<div class="container">
   <div class="row">
    ...
    <form action="{{route('order.update',$order->id)}}" id="form_edit_modal" data-url="{{route('order.update',$order->id)}}" enctype="multipart/form-data" method="post">
      @csrf
      @method('put')
      <div class="form-group">
      
        <label for="" class="d-block mb-3"><h4>Sản phẩm</h4></label>
